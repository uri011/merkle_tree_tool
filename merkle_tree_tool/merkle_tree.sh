...
do
    case $opt in
        'Create Data Files')
            ...
            /bin/bash ./scripts/docs_factory.sh $docs_dir $nodes_dir $prefixs_dir Create
        ...
        'Add Data File')
            echo -e '\nCreate Data Files Selected\n'
            /bin/bash ./scripts/prefixs_factory.sh $prefixs_dir
            /bin/bash ./scripts/docs_factory.sh $docs_dir $nodes_dir $prefixs_dir Add
        ...
        'Delete Data Files')
            ...
            /bin/bash ./scripts/prefixs_factory.sh $prefixs_dir
            /bin/bash ./scripts/docs_factory.sh $docs_dir $nodes_dir $prefixs_dir Delete
